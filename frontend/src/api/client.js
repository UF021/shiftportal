...
export const reactivateStaff           = (id)     => api.post(`/staff/${id}/reactivate`)
export const bulkBlockStaff            = (ids)    => api.post('/staff/bulk/block', { user_ids: ids })
export const getArchivedStaff          = ()       => api.get('/staff/archived')
export const archiveStaff              = (id)     => api.post(`/staff/${id}/archive`)
export const unarchiveStaff            = (id)     => api.post(`/staff/${id}/unarchive`)
...
export const uploadOrgLogo     = (image_base64) => api.post('/orgs/me/branding/logo', { image_base64 })
export const deleteOrgLogo     = ()              => api.delete('/orgs/me/branding/logo')
...
export const confirmDocRead    = (key)       => api.post(`/orgs/me/documents/${key}/confirm`)
export const getDocConfirmations = ()        => api.get('/orgs/me/documents/confirmations')
...
export const getAutoForwards         = ()           => api.get('/incidents/auto-forward')
export const upsertAutoForward       = (d)          => api.post('/incidents/auto-forward', d)
export const deleteAutoForward       = (id)         => api.delete(`/incidents/auto-forward/${id}`)

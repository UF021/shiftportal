        ...
        async function runPayReport() {
          ...
          try {
            const rows = await Promise.all([...paySelected].map(async uid => {
              ...
              // Payable hours = regular hours + BH hours × 1.5 (time and a half)
              const payableHrs   = parseFloat((regHrs + bhHrs * 1.5).toFixed(2))

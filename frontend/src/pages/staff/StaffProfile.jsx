...
export default function StaffProfile() {
  ...
  return <div>
    ...
    <div className="s-card">
      ...
      <PF label="Date of Birth" value={user?.date_of_birth}/>
    ...
    <div className="s-card">
      ...
      <PF label="Employment Start" value={user?.employment_start_date||'To be confirmed by HR'}/>
    ...
    <div className="s-card">
      ...
      <PF label="Expiry Date"    value={user?.sia_expiry}/>
      {days!==null&&(
